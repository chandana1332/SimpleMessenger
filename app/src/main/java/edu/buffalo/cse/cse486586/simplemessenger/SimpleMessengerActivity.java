...
/**
 * SimpleMessengerActivity creates an Activity (i.e., a screen) that has an
 * input box and a display box. This is almost like main() for a typical C or
 * Java program.
 *
 * Please read
 * http://developer.android.com/training/basics/activity-lifecycle/index.html
 * first to understand what an Activity is.
 *
 * Please also take look at how this Activity is declared as the main Activity
 * in AndroidManifest.xml file in the root of the project directory (that is,
